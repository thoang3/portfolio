...
n_train = 40000; % size of training subset, 60000 is full training set
...
testingImagesSubset = trainingImages(:, n_train+1:n_train+n_test);
testingLabelsSubset = trainingLabels(:, n_train+1:n_train+n_test);
